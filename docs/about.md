...
**[Apollo Automation](https://apolloautomation.com)** — A Kentucky-based open source smart home hardware company. Their LED-1 controller and M-1 LED Matrix ship with WLED firmware; they maintain a WLED-MM build optimised for their hardware.

**[Glorb](https://www.glorb.me)** — A spherical smart lamp and living sculpture running WLED with effects custom-built for its 360° surface. A direct collaboration with MoonModules.

**Tarna** — An art car whose LED installation runs on MoonModules software.

**[QuinLED](https://quinled.info)** — ESP32-based LED controller boards covering both analog dimmers and digital addressable LEDs, available as DIY kits and pre-assembled units with thorough documentation.

**[Wladislaw Waag](https://www.myhome-control.de)** (wladi) — Makes ESP32-based WLED controller boards and accessories. Also maintains the unofficial [WLED FAQ](https://wled-faq.github.io) and [WLED power calculator](https://wled-calculator.github.io) in German and English.

**hpwit** (Yves) — Author of ESPLiveScript, I2SClocklessLedDriver, and I2SClocklessVirtualLedDriver — the I2S-based LED output drivers used in MoonLight and WLED-MM.

**srg74** (Serg) — The WLED Shield PCB and the ESP flasher tool widely used across the community.

**Stefan Petrick** — Author of animartrix, the source of many generative animation effects in WLED-MM and MoonLight.
