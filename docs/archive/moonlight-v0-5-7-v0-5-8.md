...
!!! note "Archived"
    Originally published 2025-07-16. Migrated without changes. Future home: **Products**.
...
There's still an issue where the main application loop gets blocked in v0.5.7 due to ESP32 - browser interaction. We improved the following:
