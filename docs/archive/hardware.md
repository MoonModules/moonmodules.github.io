...
!!! note "Archived"
    Migrated from the original site. This page mixes two distinct topics that will be split in Sprint 4: the first three sections (Hardware we use, Designed by MoonModules, 3D Prints) belong in **Products**; everything from "Best buy guide" onward belongs in **Support**.
...
> **Sprint 4 split point**: content above goes to **Products**; content below goes to **Support**.
...
* [Prototype board 10x10cm](https://s.click.aliexpress.com/e/_EHynR3E) <img width="50" src="https://github.com/user-attachments/assets/c4e758bf-4f1a-4aa9-9f5b-a0aea70a9334">
